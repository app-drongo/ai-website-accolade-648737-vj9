...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Join thousands of small businesses who trust Accolade for their accounting needs. Our team is here to help you get started and answer any questions about our platform.',
  formTitle: 'Request a Demo',
  formDescription:
    'Schedule a personalized demo and see how Accolade can streamline your accounting workflow.',
  submitButton: 'Schedule Demo',
  contactSectionTitle: 'Talk to Our Team',
  method1Title: 'Sales Inquiries',
  method1Description: 'Speak with our sales team',
  method1Contact: 'sales@accolade.com',
  method2Title: 'Support Hotline',
  method2Description: 'Get technical assistance',
  ...
  office1Address: '250 Park Avenue, Suite 1200',
  office1Timezone: 'EST (UTC-5)',
  office2City: 'Austin',
  office2Address: '500 West 2nd Street, Floor 8',
  office2Timezone: 'CST (UTC-6)',
  office3City: 'Seattle',
  office3Address: '1918 8th Avenue, Building C',
  ...
  supportNote: 'Priority support included with all Pro and Enterprise plans',
  nameLabel: 'Full Name *',
  ...
  messagePlaceholder:
    'What accounting challenges are you facing? How many transactions do you process monthly?',
} as const;
