...
const DEFAULT_HERO = {
  ...
  titleHighlight: 'Accolade Accounting',
  description:
    'Streamline bookkeeping, automate invoicing, and get real-time financial insights. Built specifically for small businesses who need professional accounting without the complexity.',
  features: [
  ...
  imageAlt: 'Accolade dashboard showing financial overview',
