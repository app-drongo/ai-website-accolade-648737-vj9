...
const DEFAULT_FEATURES = {
  ...
  mainDescription:
    'Streamline your accounting operations with our comprehensive financial solution designed specifically for small businesses and growing enterprises.',
  ...
  feature2Description:
    'SOC 2 compliant with 256-bit encryption and role-based access controls meeting all financial regulatory requirements.',
  feature2Badge: 'Security',
  feature3Title: 'Mobile Accounting App',
  feature3Description:
    'Manage your finances on-the-go with native mobile apps for expense tracking, invoicing, and financial reporting.',
  feature3Badge: 'Mobile',
  feature4Title: 'Multi-Entity Management',
  feature4Description:
    'Handle multiple business entities, subsidiaries, and locations from a single unified financial dashboard.',
  feature4Badge: 'Multi-Entity',
  feature5Title: 'Advanced Financial Reports',
  feature5Description:
    'Generate P&L statements, balance sheets, cash flow reports, and tax-ready documents with 40+ built-in templates.',
  ...
  feature7Title: 'Banking & Payment Integrations',
  feature7Description:
    'Connect with 12,000+ banks and payment processors including QuickBooks, Stripe, and PayPal via secure APIs.',
  feature7Badge: 'Integration',
  feature8Title: 'Expert CPA Support',
  feature8Description:
    'Access certified public accountants and tax professionals with dedicated support and 99.9% uptime guarantee.',
  feature8Badge: 'Support',
  feature9Title: 'Data Security & Backup',
  feature9Description:
    'Your financial data is encrypted, backed up hourly, and stored in SOC 2 compliant data centers with full audit trails.',
  feature9Badge: 'Privacy',
  ctaQuestion: 'Ready to simplify your business accounting?',
  primaryCTA: 'Start Free 14-Day Trial',
  primaryCTAHref: '/',
  secondaryCTA: 'Book Demo with CPA',
  secondaryCTAHref: '/',
} as const;
