...
const DEFAULT_FOOTER = {
  logoText: 'Accolade',
  companyDescription:
    'Empowering organizations with innovative recognition and performance management solutions. Trusted by Fortune 500 companies to drive employee engagement and business success.',
  contactEmail: 'hello@accolade.com',
  contactPhone: '+1 (555) 847-2200',
  contactAddress: '1250 Innovation Drive, Suite 400, San Francisco, CA',
  newsletterTitle: 'Stay Connected',
  newsletterPlaceholder: 'Enter your email address',
  newsletterDisclaimer:
    'Get insights on employee engagement and recognition trends. Unsubscribe anytime.',
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'Recognition Hub', href: '/recognition', editableId: 'link-footer-recognition' },
        { name: 'Performance Analytics', href: '/analytics', editableId: 'link-footer-analytics' },
        { name: 'Rewards Catalog', href: '/rewards', editableId: 'link-footer-rewards' },
    ...
    },
    {
      ...
      links: [
        ...
        },
        {
          name: 'Best Practices',
          href: '/best-practices',
          editableId: 'link-footer-best-practices',
        },
        { name: 'Webinar Series', href: '/webinars', editableId: 'link-footer-webinars' },
        { name: 'Customer Stories', href: '/customers', editableId: 'link-footer-customers' },
